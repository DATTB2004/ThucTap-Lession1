...
export const MyUser = () => {
  ...
  const myUserList = useAppSelector(state => state.gateway.myUser.entities);
  ...
  return (
    <div>
      <h2 id="my-user-heading" data-cy="MyUserHeading">
        <Translate contentKey="gatewayApp.microserviceMyUser.home.title">My Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.microserviceMyUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/my-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.microserviceMyUser.home.createLabel">Create new My User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {myUserList && myUserList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.microserviceMyUser.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('idUser')}>
                  <Translate contentKey="gatewayApp.microserviceMyUser.idUser">Id User</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('idUser')} />
                </th>
                <th className="hand" onClick={sort('userName')}>
                  <Translate contentKey="gatewayApp.microserviceMyUser.userName">User Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('userName')} />
                </th>
                <th className="hand" onClick={sort('password')}>
                  <Translate contentKey="gatewayApp.microserviceMyUser.password">Password</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.microserviceMyUser.home.notFound">No My Users found</Translate>
            </div>
          )
        )}
      </div>
