...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.bksoft.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.bksoft.security.DomainUserDetailsService", "createSpringSecurityUser");
