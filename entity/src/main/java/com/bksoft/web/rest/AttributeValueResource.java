...
/**
 * REST controller for managing {@link com.bksoft.domain.AttributeValue}.
 */
@RestController
...
public class AttributeValueResource {
    ...
    private static final String ENTITY_NAME = "entityAttributeValue";
     ...
     */
    @PostMapping("")
    public ResponseEntity<AttributeValue> createAttributeValue(@Valid @RequestBody AttributeValue attributeValue)
    ...
    public ResponseEntity<AttributeValue> updateAttributeValue(
        ...
        @Valid @RequestBody AttributeValue attributeValue
    ) throws URISyntaxException {
    ...
    public ResponseEntity<AttributeValue> partialUpdateAttributeValue(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AttributeValue attributeValue
    ) throws URISyntaxException {
