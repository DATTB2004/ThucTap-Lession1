...
import { IAttribute, defaultValue } from 'app/shared/model/entity/attribute.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './attribute.reducer';
