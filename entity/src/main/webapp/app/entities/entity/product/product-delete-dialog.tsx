...
export const ProductDeleteDialog = () => {
  ...
  const productEntity = useAppSelector(state => state.entity.product.entity);
  const updateSuccess = useAppSelector(state => state.entity.product.updateSuccess);

  const handleClose = () => {
    navigate('/entity/product');
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityApp.entityProduct.delete.question">Are you sure you want to delete Product {productEntity.id}?</ModalBody>
      <ModalFooter>
